...
// Mon Aug 21 10:52:15 2017 by ROOT version 5.34/36
// from TTree MueKst/MueKst
// found on file: MueKst-mc-xll-new.root
//////////////////////////////////////////////////////////

#ifndef ntuple_MVAJ_h
#define ntuple_MVAJ_h
...
//#ifdef ntuple_MVAJ_cxx
ntuple_MVAJ::ntuple_MVAJ(TTree *tree) : fChain(0) 
{
...
ntuple_MVAJ::~ntuple_MVAJ()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ntuple_MVAJ::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ntuple_MVAJ::LoadTree(Long64_t entry)
{
...
void ntuple_MVAJ::Init(TTree *tree)
{
...
void ntuple_MVAJ::Show(Long64_t entry)
{
...
Int_t ntuple_MVAJ::Cut(Long64_t entry)
{
