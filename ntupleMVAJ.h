...
// Tue Aug  1 11:41:22 2017 by ROOT version 5.34/36
...
//#ifdef ntupleMVAJ_cxx
ntupleMVAJ::ntupleMVAJ(TTree *tree) : fChain(0) 
{
...
ntupleMVAJ::~ntupleMVAJ()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ntupleMVAJ::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ntupleMVAJ::LoadTree(Long64_t entry)
{
...
void ntupleMVAJ::Init(TTree *tree)
{
...
void ntupleMVAJ::Show(Long64_t entry)
{
...
Int_t ntupleMVAJ::Cut(Long64_t entry)
{
